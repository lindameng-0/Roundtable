  ...
  return <header className="site-header no-print">
    <div className="site-header-inner">
      ...
      <nav className="site-nav" aria-label="Main navigation">
        {user ? <><NavLink to="/dashboard">Manuscripts</NavLink><NavLink to="/setup">New manuscript</NavLink>{user.is_owner && <NavLink to="/owner/analytics">Analytics</NavLink>}</> : <><a href="/#how-it-works">How it works</a><NavLink to="/pricing">Plans &amp; credits</NavLink></>}
      </nav>
