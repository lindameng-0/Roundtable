...
export function SiteFooter() {
  return <footer className="site-footer no-print"><Brand /><p>A little perspective for your next draft.</p><nav className="site-footer-links" aria-label="Resources, pricing and policies"><a href="/guides/">Writing guides &amp; worksheets</a><Link to="/use-cases/">Writing use cases</Link><Link to="/connect-assistant/">Assistant connections</Link><Link to="/sample-reading/">Sample reading</Link><Link to="/beta-readers/">Beta readers</Link><Link to="/ai-beta-reader/">AI beta readers</Link><Link to="/manuscript-feedback/">Manuscript feedback</Link><Link to="/pricing/">Pricing</Link><Link to="/terms/">Terms of service</Link><Link to="/privacy/">Privacy policy</Link><Link to="/refunds/">Refund policy</Link></nav></footer>;
}
