...
export default function HomePage() {
  return <><SiteHeader /><main id="main-content" tabIndex={-1}>
    <section className="home-hero page-width">
      <div className="hero-copy"><p className="small-note"><span className="short-rule" />AI beta readers for fiction writers</p><h1>Meet your story<br />through other eyes.</h1><p className="hero-description">Get passage-level feedback on character, pacing, and plot from up to five distinct AI readers. Compare their perspectives and decide what serves your story.</p><div className="hero-actions"><Link to="/signup" className="button button-primary">Bring your manuscript <ArrowUpRight size={18} /></Link><Link to="/sample-reading" className="text-link">Explore a sample reading</Link></div><p className="hero-footnote">Try your first reading free. No card needed.</p><p className="hero-footnote"><strong>Your draft stays yours.</strong> We don’t publish your writing or use it to train AI. <Link to="/privacy" className="text-link">How we protect your work</Link></p><div className="hero-colophon"><TableMark /><p>For the draft you believe in.<br />And the one you’re still figuring out.</p></div></div>
      <ReadingExample />
    </section>
