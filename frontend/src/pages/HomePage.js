...
export default function HomePage() {
  return <><SiteHeader /><main id="main-content" tabIndex={-1}>
    <section className="home-hero page-width">
      <div className="hero-copy"><p className="small-note"><span className="short-rule" />A reading room for your manuscript</p><h1>Meet your story<br />through other eyes.</h1><p className="hero-description">You know what you meant to write. Discover what your readers feel, question, and remember—with a panel of distinct AI perspectives.</p><div className="hero-actions"><Link to="/signup" className="button button-primary">Bring your manuscript <ArrowUpRight size={18} /></Link><a href="#reading-example" className="text-link">Explore the example</a></div><p className="hero-footnote">Try your first reading free. No card needed.</p><div className="hero-colophon"><TableMark /><p>For the draft you believe in.<br />And the one you’re still figuring out.</p></div></div>
      <ReadingExample />
    </section>
